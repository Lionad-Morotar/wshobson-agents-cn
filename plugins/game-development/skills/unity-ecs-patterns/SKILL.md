...
description: 精通 Unity ECS（实体组件系统）以及 DOTS、Jobs 和 Burst，用于高性能游戏开发。在构建面向数据的游戏、优化性能或处理大量实体时使用。
---

# Unity ECS 模式

Unity 面向数据技术栈 (DOTS) 的生产模式，包括实体组件系统、Job System 和 Burst Compiler。
...
// 4. 使用 ScheduleParallel 与 chunk 迭代
[BurstCompile]
