...
掌握 Material Design 3 (Material You) 和 Jetpack Compose,构建现代、自适应的 Android 应用,与 Android 生态系统无缝集成。
...
**个性化**: 动态颜色使 UI 适应用户的壁纸
**无障碍性**: 色调调色板确保足够的颜色对比度
**大屏幕**: 为平板电脑和可折叠设备提供响应式布局
