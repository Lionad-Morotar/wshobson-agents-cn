...
4. **版本化令牌**:将令牌更改视为使用 semver 的 API 更改
5. **测试主题组合**:验证所有主题与所有组件一起工作
6. **自动化令牌管道**:Figma 到代码同步的 CI/CD
7. **提供迁移路径**:使用明确的替代方案逐步弃用令牌
...
- **硬编码值**:使用原始值而非令牌
- **循环引用**:令牌在循环中相互引用
- **平台差距**:某些平台缺少令牌(Web 但非移动)

## 资源

- [Style Dictionary 文档](https://amzn.github.io/style-dictionary/)
- [Figma 的 Tokens Studio](https://tokens.studio/)
- [设计令牌 W3C 规范](https://design-tokens.github.io/community-group/format/)
- [Radix UI 主题](https://www.radix-ui.com/themes)
