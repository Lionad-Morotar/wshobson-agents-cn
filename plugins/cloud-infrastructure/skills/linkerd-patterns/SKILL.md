...
Linkerd 服务网格的生产模式——Kubernetes 的轻量级、安全优先服务网格。
...
- ** everywhere 启用 mTLS** - Linkerd 自动处理
...
- [服务配置文件](https://linkerd.io/2.14/features/service-profiles/)
